...
const discoveryModes = <DiscoveryMode>[
  ...
  DiscoveryMode(
    id: 'outdoor-ideas',
    title: 'Outdoor Ideas',
    shortSubtitle: 'Fresh air, nature and adventure.',
    longDescription:
        'Find low-friction outdoor plans around parks, trails, views, shade, timing, and weather fit.',
    category: ModeCategory.healthOutdoors,
    iconSemanticName: 'forest',
    accentColor: AppColors.green,
    defaultFilters: [
      ModeDefaultFilter(id: 'pace', label: 'Pace', value: 'Easy'),
      ModeDefaultFilter(id: 'shade', label: 'Shade', value: 'Preferred'),
      ModeDefaultFilter(id: 'time', label: 'Time', value: 'Under 2 hours'),
    ],
    ...
    demoResults: [
      ModeDemoResult(
        title: 'Creek Trail Reset',
        subtitle: 'Shaded loop with a coffee stop nearby',
        detail: 'A quick fresh-air route for a low-planning afternoon.',
        distanceLabel: '2.4 mi',
        imageSemanticName: 'outdoor',
        tags: ['Trail', 'Shade', 'Coffee nearby'],
      ),
      ModeDemoResult(
        title: 'Sunset Park Pairing',
        subtitle: 'Easy overlook, picnic tables, and short walk',
        detail: 'A gentle plan that works for solo time or a small group.',
        distanceLabel: '18 min',
        imageSemanticName: 'outdoor',
        tags: ['Views', 'Picnic', 'Low effort'],
      ),
    ],
  ),
  DiscoveryMode(
