...
const discoveryModes = <DiscoveryMode>[
  ...
  DiscoveryMode(
    id: 'open-now',
    title: 'Open Now',
    shortSubtitle: 'Useful nearby places that are open right now.',
    longDescription:
        'Skip closed doors with a focused list of nearby food, coffee, shops, services, and activities that are open now.',
    category: ModeCategory.goOut,
    ...
    defaultFilters: [
      ...
      ModeDefaultFilter(id: 'budget', label: 'Budget', value: 'Any'),
      ModeDefaultFilter(id: 'open', label: 'Open', value: 'Open now'),
    ],
    queryStrategyType: ModeQueryStrategyType.nearbyPlaces,
    hasCustomScreen: false,
    ...
    demoResults: [
      ModeDemoResult(
        ...
        subtitle: 'Coffee, snacks, and counter seating open late',
        detail: 'A nearby option for a quick stop without a reservation.',
        distanceLabel: '0.8 mi',
        imageSemanticName: 'food',
        tags: ['Open now', 'Coffee', 'Casual'],
      ),
      ModeDemoResult(
        title: 'Central Market Hall',
        subtitle: 'Food counters, essentials, and indoor seating',
        detail: 'A flexible fallback when the group wants different things.',
        distanceLabel: '1.6 mi',
        imageSemanticName: 'food',
        tags: ['Open now', 'Food hall', 'Indoor'],
      ),
    ],
  ),
  DiscoveryMode(
    ...
    demoResults: [
      ModeDemoResult(
        ...
        detail: 'An example of a gentler outdoor planning option.',
  ...
  DiscoveryMode(
    ...
    demoResults: [
      ModeDemoResult(
        ...
        detail: 'An example plan for heat and air-quality constraints.',
  ...
  DiscoveryMode(
    ...
    demoResults: [
      ModeDemoResult(
        ...
        subtitle: 'Afternoon exposure requires address-based analysis',
  ...
  DiscoveryMode(
    ...
    demoResults: [
      ModeDemoResult(
        ...
        detail: 'A practical preview of what a neighborhood scan can show.',
  ...
  DiscoveryMode(
    ...
    demoResults: [
      ModeDemoResult(
        ...
        detail: 'An example output for lifestyle-based ranking.',
